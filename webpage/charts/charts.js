...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const path = '/webpage/charts/charts/occupation/cars/occup-cars-'
    const idimage = 'displayedImagecarso'
    console.log(path)
    

    defaultImageCars = '/webpage/charts/charts/occupation/cars/occup-cars-total.png';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const path ='/webpage/charts/charts/occupation/bikes/occup-bikes-'
    const idimage = "displayedImagebikeo"

    
    defaultImageBikes = '/webpage/charts/charts/occupation/bikes/occup-bikes-total.png'
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const images = ['Antigone', 'Cémedie', 'Corum', 'Europa', 'Foch', 'Gambetta', 'Gare', 'Triangle', 'Pitot', 'Circe', 'Garcia Lorca', 'Mosson', 'Sabines', 'Sablassou', 'Saint Jean Le Sec', 'Euromedecine', 'Occitanie', 'Vicarello', 'Gaumont EST', 'Gaumont OUEST', 'Charles de Gaulle', 'Polygone', 'Arc de Triomphe']; 
    const path = '/webpage/charts/charts/moyenne_remplissage/cars/avg_cars-'
    const idimage = 'displayedImagecarsm'
   
    

    const defaultImageCars = '/webpage/charts/charts/moyenne_remplissage/cars/avg_cars-total.png';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const idimage = "displayedImagebikem"

    
    const defaultImageBikes = '/webpage/charts/charts/moyenne_remplissage/bikes/avg_bikes-total.png'
